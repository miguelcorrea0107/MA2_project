...
C {sky130_fd_pr/cap_mim_m3_1.sym} 170 50 0 0 {name=C2 model=cap_mim_m3_1 W=47 L=48 MF=1 spiceprefix=X}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} -130 0 3 0 {name=C1 model=cap_mim_m3_1 W=42 L=42 MF=1 spiceprefix=X}
