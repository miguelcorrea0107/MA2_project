...
C {sky130_fd_pr/cap_mim_m3_1.sym} 170 50 0 0 {name=C2 model=cap_mim_m3_1 W=30 L=30 MF=1 spiceprefix=X}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} -130 0 3 0 {name=C1 model=cap_mim_m3_1 W=18 L=18 MF=1 spiceprefix=X}
