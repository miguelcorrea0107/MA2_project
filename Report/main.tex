...
\thesistitle{Microelectronic circuit design for neural interfaces in 0.18um CMOS technology using an open source VLSI ecosystem} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\group{\href{http://researchgroup.university.com}{BSSE}} % Your research group's name and URL, this is used in the title page, print it elsewhere with \groupname
...
This semester project, titled "Microelectronic Circuit Design for Neural Interfaces in 0.18um CMOS Technology Using an Open Source VLSI Ecosystem," focuses on advancing the capabilities of the BSSE group in the domain of IC design using open-source tools. The project explores the feasibility of designing a CMOS inverter-based amplifier for neural interfaces, leveraging accessible and collaborative resources to enhance the group's technical prowess and innovation capacity.

The primary objectives include developing a CMOS inverter-based amplifier that meets specific design specifications, demonstrating the capabilities of various open-source tools throughout the IC design workflow, and creating a comprehensive guide for future projects within the BSSE group. The design workflow utilizes tools such as Xschem for schematic capture, Ngspice for circuit simulation, Magic for layout design, and Netgen for layout versus schematic (LVS) checks, all integrated with the SkyWater SKY130 PDK.

The designed amplifier aims to enhance the signal-to-noise ratio (SNR) for extracellular recordings of neural networks, which is crucial for high-fidelity neural recordings. This project underscores the potential of open-source tools to reduce development costs, foster collaboration, and accelerate advancements in microelectronics within the BSSE group.

By the conclusion of this project, a robust CMOS inverter-based amplifier design was successfully simulated and verified, ready for fabrication. The extensive documentation provided serves as a valuable reference for future open-source IC design projects within the BSSE group, significantly contributing to the group's knowledge base and technical capabilities.
\end{abstract}
